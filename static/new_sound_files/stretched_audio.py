...
# 대상 파일 리스트
input_dir = '/Users/two_jyy/project_openSW/sound_files_drum'
output_dir = '/Users/two_jyy/project_openSW/new_sound_files'
start_index = 25
end_index = 37
...
for i in range(start_index, end_index + 1):
    ...
    output_filename = f'{output_dir}/stretched_audio_{i}.wav'
